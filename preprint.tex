...
\midrule
1 & 99783 & 0.29 & 0.23 & 0.21 & 0.00 & 3.33 & 3.33 & 2.35 & 9.78\\
...
\addlinespace
6 & 49 & 496.73 & 427.36 & 243.74 & 68.91 & 1031.78 & 962.88 & 0.36 & -0.91\\
...
{\centering \includegraphics[width=1\linewidth]{figuras/acumulacion-flujo-y-red-rwshed} 
...
{\centering \includegraphics[width=1\linewidth]{figuras/red-indiferenciada} 
...
{\centering \includegraphics[width=1\linewidth]{figuras/red-orden} 
...
\ControlFlowTok{for}\NormalTok{ i }\KeywordTok{in} \KeywordTok{\textasciigrave{}}\BuiltInTok{echo} \DataTypeTok{\{}\DecValTok{1}\DataTypeTok{..}\DecValTok{8}\DataTypeTok{..}\DecValTok{1}\DataTypeTok{\}}\KeywordTok{\textasciigrave{};} \DataTypeTok{\textbackslash{}}
  \ControlFlowTok{do} \BuiltInTok{echo} \AttributeTok{{-}e} \StringTok{"\textbackslash{}nTRABAJANDO EL ORDEN }\VariableTok{$i}\StringTok{...\textbackslash{}n"}\KeywordTok{;} \DataTypeTok{\textbackslash{}}
    \BuiltInTok{time}\NormalTok{ r.to.vect }\AttributeTok{{-}{-}overwrite}\NormalTok{ input=rstream\_cuencas\_strahler\_umbral\_540\_orden\_}\VariableTok{$i} \DataTypeTok{\textbackslash{}}
...
\NormalTok{    name=foo}
\ControlFlowTok{done}
\CommentTok{\# Tiempos uso de CPU, órdenes 1 a 8}
\CommentTok{\# real  2m0.180s}
\CommentTok{\# real  0m49.778s}
\CommentTok{\# real  0m32.943s}
\CommentTok{\# real  0m28.137s}
\CommentTok{\# real  0m28.078s}
\CommentTok{\# real  0m26.906s}
\CommentTok{\# real  0m25.886s}
\CommentTok{\# real  0m25.624s}
...
\CommentTok{\#\# Exportar el mapa \textquotesingle{}rstream\_orden\_de\_red\_umbral\_540\textquotesingle{} a GeoPackage}
...
\NormalTok{  output=gpkg{-}shp/rstream\_orden\_de\_red\_umbral\_540.gpkg }\DataTypeTok{\textbackslash{}}
...
\NormalTok{  format=GPKG}
\CommentTok{\#\# Exportar el mapa \textquotesingle{}rstream\_orden\_de\_red\_umbral\_540\textquotesingle{} a Shapefile}
\ExtensionTok{ogr2ogr} \AttributeTok{{-}f} \StringTok{"ESRI Shapefile"} \DataTypeTok{\textbackslash{}}
\NormalTok{  gpkg{-}shp/rstream\_orden\_de\_red\_umbral\_540.shp }\DataTypeTok{\textbackslash{}}
\NormalTok{  gpkg{-}shp/rstream\_orden\_de\_red\_umbral\_540.gpkg}
\CommentTok{\#\# Exportar el mapa \textquotesingle{}rstream\_cuencas\_strahler\_terminal\_umbral\_540\_todos\_cleaned\textquotesingle{}}
...
\NormalTok{  cuencas\_subcuencas }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\FunctionTok{as.character}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{8}\NormalTok{), }\ControlFlowTok{function}\NormalTok{(x) \{}
    \FunctionTok{st\_read}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}gpkg{-}shp/rstream\_cuencas\_strahler\_umbral\_540\_orden\_\textquotesingle{}}\NormalTok{, x, }\StringTok{\textquotesingle{}.gpkg\textquotesingle{}}\NormalTok{))}
