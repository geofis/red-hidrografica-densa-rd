...
Obtuvimos los mapas de cuencas y subcuencas para cada orden. Primero, extrajimos los límites del país hacia el directorio `gpkg-shp` para disponer de un contexto en los mapas generados a continuación.
